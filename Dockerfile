...
RUN echo "deb [signed-by=/etc/apt/trusted.gpg.d/naemon.asc] https://ftp.gwdg.de/pub/opensuse/repositories/home:/naemon/Debian_$(lsb_release -rs)/ ./" >> /etc/apt/sources.list.d/naemon-stable.list
